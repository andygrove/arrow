...
use arrow::array::{Array, PrimitiveBuilder, PrimitiveArray, BinaryBuilder, TimestampNanosecondBuilder};
use arrow::datatypes::{Schema, Field, DataType, DateUnit, TimeUnit, ArrowPrimitiveType, BooleanType,
                       Date32Type, Date64Type, Time32MillisecondType, Int32Type, Int64Type,
                       Float32Type, Float64Type,
                       Time64NanosecondType, Time64MicrosecondType, TimestampMicrosecondType, TimestampMillisecondType};
...
pub struct ParquetScanPartition {
    schema: Arc<Schema>,
    request_tx: Sender<()>,
